...
from primermvt.views import grupofliar, mascotas, vehiculos, show_familiar, show_mascota, show_vehiculo, search_view, detail_familiar, eliminar_familiar, detail_mascota, eliminar_mascota, detail_vehiculo, eliminar_vehiculo
